                ...
                case UI::DataWrapper::Frames::Pages::NEWS: {
...

                    {
                        ...
                        UI::AdvancedRender::RenderContactInteractiveBoxCase ("##contactscomm", UI::DataWrapper::Language::TranslateMessage ("news.con.com"), {
                            ...
                            { UI::DataWrapper::Language::TranslateMessage ("news.con.com.git"),  "https://www.github.com/__cpuid/otv2-pl"  }
                        ...
                        switch (UI::DataWrapper::Frames::GetCurrentLoadPage ()) {
                            ...
                            case UI::DataWrapper::Frames::LoadPages::README: {
...

                                {
                                    ...
                                    //Cheat problems.
                                    UI::AdvancedRender::RenderText (ImColor (159, 57, 57, 255), UI::DataWrapper::Language::TranslateMessage ("load.rm.ik.name"));
                                    UI::AdvancedRender::RenderText (ImColor (255, 255, 255, 255), UI::DataWrapper::Language::TranslateMessage ("load.rm.ik.ls"));

                                    ImGui::Dummy (ImVec2 (0.f, 4.f));

                                    //Useful links.
                                    UI::AdvancedRender::RenderText (ImColor (159, 57, 57, 255), UI::DataWrapper::Language::TranslateMessage ("load.rm.lk.name"));
                                    UI::AdvancedRender::RenderText (ImColor (255, 255, 255, 255), LanguageProvider::GetRegionalMessageFromBuffer (LanguageProvider::Region::EN, LanguageProvider::BufferType::UI, "load.rm.lk.ls"));
