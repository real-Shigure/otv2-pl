...
std::map <std::string, const char*> LanguageProvider::Buffers::UIMessages = {
        ...
        { "load.rm.lk.name.en",   u8"Useful links: "  },
        { "load.rm.lk.name.ru", u8"Полезные ссылки: " },

        { "load.rm.lk.ls.en", u8"        <- OTv2 IDB: https://www.github.com/cpu-id/otv2reverse.\n        <- Primal-loader: https://github/cpu-id/primal-loader." },
...
std::map <std::string, const char*> LanguageProvider::Buffers::PrimalMessages = {
        ...
        { "primal.prep.seg.bef.dbg.ru", u8"Рутинна сегмента: Обновить оффсеты, обновить интерфейсы, и внутренние фиксы." },
        { "primal.passed.seg.bef.dbg.en", u8"The segment has finished executing the routine." },
        { "primal.passed.seg.bef.dbg.ru", u8"Сегмент закончил выполнять рутинну." },
        { "primal.prep.thr.dbg.en", u8"Calling CRT_DllMain from segment... (OEP)" },
