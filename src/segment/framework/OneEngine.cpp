...
void OneEngine::SetupHooks () {
    ...
    DetourFunction (reinterpret_cast <PBYTE> (Primal::GetAllocationPointer () + OneSDK::MemoryController::HookData::CallVirtualFunction__OffsetToHook), reinterpret_cast <PBYTE> (OneSDK::MemoryController::CallVirtualFunction));
...
void OneEngine::SetupInfoTable () {
    ...
    //                                                                                                                                                           //
        CommonUtil::FindOffsetsToVec (m_libraries.at (0), m_interfaces, info);                                                                                   //
    //                                                                                                                                                           //
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                                                                                           //
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //                                                                                                                                                           //
        std::memmove (reinterpret_cast <PVOID> (Primal::GetAllocationPointer () + 0x20), reinterpret_cast <PVOID> (info.data ()), 0x18C);                        //
    //                                                                                                                                                           //
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void OneEngine::InstallMicroPatches () {
    ...
    for (const auto& netvar : m_netvars) {
        *reinterpret_cast <int*> (Primal::GetAllocationPointer () + netvar.m_rva) = netvar.m_value;
    }
    ...
    **/
    ...
    auto UpdateLegacyInstructionString = [](char compressedArray[], int offsetToInstructions, int instructionIteratorBase, int instructionCount, int iterationCycleUpdate, int instructionCharMoveCount, int arrayCharIteratorBase, int arrayCharCycleUpdate) {
        ...
        for (int instructionsIterator = instructionIteratorBase; instructionsIterator < instructionCount; instructionsIterator += iterationCycleUpdate) {
            std::memcpy (reinterpret_cast <int*> (Primal::GetAllocationPointer () + offsetToInstructions + instructionsIterator), compressedArray + segmentedCharIterator, instructionCharMoveCount);
    ...
    //Start watermark [box].
        ...
        std::memmove (reinterpret_cast <int*> (Primal::GetAllocationPointer () + 0x1), userName, 0x20);

    //End of watermark [box].

    //Start watermark [menu].

        //Update string inside function mov instruction.
        UpdateLegacyInstructionString ("OneTap v2", 0xE025F, 0x0, 0x15, 0x7, 0x4, 0x0, 0x4);

    //End of watermark [menu].
